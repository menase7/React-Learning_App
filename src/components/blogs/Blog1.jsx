...
import panda from '../images/blog/animal2.jpg'
...
const Blog1 = () => {
  return (
    <motion.div
        ...
        className='blogs-buttom grid lg:grid-cols-2 lg:m-14 m-6 text-white rounded-[40px] bg-[#6222cc] h-[60%]'>
        <div className="bt-left flex flex-col gap-10  p-14">
          <p className='text-center'>Ethiopian Kids & playing Musics</p>
          <p>
        ...
        <div className="bt-right lg:py-14 lg:pr-16 flex flex-col justify-center m-5">
          <img className='rounded-[5%]' src={panda} alt="panda" />
        </div>
      </motion.div>
  )
}
