...
import img from '../images/blog/kids5.jpg'
...
const Blog2 = () => {
  return (
    <motion.div
        ...
        className='blogs-buttom duration-200 grid lg:grid-cols-2 lg:m-14 m-6 text-white rounded-[40px] bg-[#008000] h-[60%]'>
        <div className="bt-left flex flex-col gap-10  p-14">
          <p className='text-center'>Healthy Food & Life</p>
          <p>
        ...
        <div className="bt-right lg:py-14 lg:pr-16 flex flex-col justify-center m-5">
          <img className='rounded-[5%]' src={img} alt="students" />
        </div>
      </motion.div>
  )
}
