...
import kids from '../images/blog/kids2.jpg'
...
const Blog3 = () => {
  return (
    <motion.div
        ...
        className='blogs-buttom grid lg:grid-cols-2 lg:m-14 m-6 text-white rounded-[40px] bg-[#ffa500] h-[60%]'>
        <div className="bt-left flex flex-col gap-10  p-14">
          <p className='text-center'>Read daily & Makes You Perfect</p>
          <p>
        ...
        <div className="bt-right lg:py-14 lg:pr-16 flex flex-col justify-center m-5">
          <img className='rounded-[5%]' src={kids} alt="kids" />
        </div>
      </motion.div>
  )
}
